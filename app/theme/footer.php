...
?>
	...
	<footer class="footer content_wrapper">
        ...
        <div class="footer__section __last">
            <a href="/#prices_section" class="keepInTouch"><?= __('Keep in touch')?></a>
            <div class="contacts">

                <ul class="social__media">
	                <?php if (isset($redux_demo['socialMedia-linkedin'])) { ?>
                        <li class="social__media__item"> <a target="_blank" href="<?= $redux_demo['socialMedia-linkedin'] ?>"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
	                ...
	                <?php if (isset($redux_demo['socialMedia-facebook'])) { ?>
                        <li class="social__media__item"> <a target="_blank" href="<?= $redux_demo['socialMedia-facebook'] ?>"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
	                ...
	                <?php if (isset($redux_demo['socialMedia-instagram'])) { ?>
                        <li class="social__media__item"> <a target="_blank" href="<?= $redux_demo['socialMedia-instagram'] ?>"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
