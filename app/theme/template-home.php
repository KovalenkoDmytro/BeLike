                ...
                <div class="section__image">
                    ...
                    <ul class="social__media">
						<?php if ( isset( $redux_demo['socialMedia-linkedin'] ) ) { ?>
                            <li class="social__media__item"><a target="_blank" href="<?= $redux_demo['socialMedia-linkedin'] ?>">
						...
						<?php if ( isset( $redux_demo['socialMedia-facebook'] ) ) { ?>
                            <li class="social__media__item"><a target="_blank" href="<?= $redux_demo['socialMedia-facebook'] ?>">
						...
						<?php if ( isset( $redux_demo['socialMedia-instagram'] ) ) { ?>
                            <li class="social__media__item"><a target="_blank"
                                        href="<?= $redux_demo['socialMedia-instagram'] ?>">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="achievements">
							<?php foreach ( $second_section['text_thumbnails'] as $text_thumbnail ): ?>
                                <div class="achievement">
                                    <p class="mainText">
                                        <span class="counter" data-target="<?= $text_thumbnail['text_thumbnail']['bold_text'] ?>"></span>
                                        <span ><?= $text_thumbnail['text_thumbnail']['second_bold_text'] ?></span>
                                    </p>
