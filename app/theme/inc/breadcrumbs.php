...
function get_breadcrumbs(): void {
	...
	$text['home']     = __('Home','dk-starter');
	$text['category'] = __('Archive','dk-starter').' "%s"';
	$text['search']   = __('Search results','dk-starter').' "%s"';
	$text['tag']      = __('Tag','dk-starter').' "%s"';
	$text['author']   = __('Author','dk-starter').' %s';
	$text['404']      = __('Error 404','dk-starter');
